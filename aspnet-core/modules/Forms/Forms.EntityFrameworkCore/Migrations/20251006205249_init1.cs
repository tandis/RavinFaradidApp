        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAnonymousAllowed = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionLevel = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FormId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    VersionNumber = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    JsonDefinition = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ThemeDefinition = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DefinitionHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_FormVersion_Json_IsJson", "ISJSON([JsonDefinition])=1");
                    table.CheckConstraint("CK_FormVersion_Theme_IsJson", "[ThemeDefinition] IS NULL OR ISJSON([ThemeDefinition])=1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_FormResponse_IsJson", "ISJSON([ResponseData])=1");
                    table.ForeignKey(
                        name: "FK_FormResponses_FormVersions_FormVersionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormPermissions_FormId_UserId_RoleId",
                table: "FormPermissions",
                columns: new[] { "FormId", "UserId", "RoleId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormResponses_FormVersionId",
                table: "FormResponses",
