...
public class RavinaFaradidDbContext :
    AbpDbContext<RavinaFaradidDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public RavinaFaradidDbContext(DbContextOptions<RavinaFaradidDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(RavinaFaradidConsts.DbTablePrefix + "YourEntities", RavinaFaradidConsts.DbSchema);
